...
if __name__ == "__main__":
    ...
    input_file_name: str = "../corpora/ghana-stakeholders/stakeholders/stakeholders.tsv"
    output_file_name: str = "../corpora/ghana-stakeholders/stakeholders/stakeholders-a.tsv"
