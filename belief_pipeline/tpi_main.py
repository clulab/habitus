...
if __name__ == "__main__":
    ...
    input_file_name: str = "../corpora/ghana-regulations/dataset/ghana-regulations.tsv"
    output_file_name: str = "../corpora/ghana-regulations/dataset/ghana-regulations-a.tsv"
