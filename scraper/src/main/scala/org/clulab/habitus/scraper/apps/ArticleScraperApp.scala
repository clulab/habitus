...
//  val corpusFileName = args.lift(0).getOrElse("./scraper/citifmonline_articlecorpus.txt")
  val corpusFileName = args.lift(0).getOrElse("./scraper/corpora/multi3/price/articlecorpus.txt")
  val baseDirName = args.lift(1).getOrElse("../corpora/multi3/price/articles")
