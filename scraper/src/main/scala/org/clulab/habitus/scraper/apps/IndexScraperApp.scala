...
//  val articleFileName = args.lift(1).getOrElse("./scraper/articlecorpus-illegal-mining.txt")
  ...
  val corpusFileName = args.lift(0).getOrElse("./scraper/corpora/uganda/uganda mining/indexcorpus.txt")
  val articleFileName = args.lift(1).getOrElse("./scraper/corpora/uganda/uganda mining/articlecorpus.txt")
  val baseDirName = args.lift(1).getOrElse("../corpora/uganda/uganda mining/indexes")
