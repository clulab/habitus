...
//  val corpusFileName = args.lift(0).getOrElse("./scraper/indexcorpus-illegal-mining.txt")
  val corpusFileName = args.lift(0).getOrElse("./scraper/corpora/multi/galamsey/indexcorpus.txt")
...
//  val articleFileName = args.lift(1).getOrElse("./scraper/articlecorpus-illegal-mining.txt")
  val articleFileName = args.lift(1).getOrElse("./scraper/corpora/multi/galamsey/articlecorpus.txt")

  val baseDirName = args.lift(1).getOrElse("../corpora/multi/galamsey/indexes")
