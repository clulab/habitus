...
//  val articleFileName = args.lift(1).getOrElse("./scraper/articlecorpus-illegal-mining.txt")
  ...
  val corpusFileName = args.lift(0).getOrElse("./scraper/corpora/multi3/gold/indexcorpus.txt")
  val articleFileName = args.lift(1).getOrElse("./scraper/corpora/multi3/gold/articlecorpus.txt")
  val baseDirName = args.lift(1).getOrElse("../corpora/multi3/gold/indexes")
