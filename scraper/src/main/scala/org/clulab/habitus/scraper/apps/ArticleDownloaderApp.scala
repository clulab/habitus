...
//  val corpusFileName = args.lift(0).getOrElse("./scraper/articlecorpus-illegal-galamsey.txt")
  val corpusFileName = args.lift(0).getOrElse("./scraper/corpora/uganda/uganda china/articlecorpus.txt")
  val baseDirName = args.lift(1).getOrElse("../corpora/uganda/uganda china/articles")
