...
//  val corpusFileName = args.lift(0).getOrElse("./scraper/articlecorpus-illegal-mining.txt")
  val corpusFileName = args.lift(0).getOrElse("./scraper/corpora/multi/mining/articlecorpus.txt")
  val baseDirName = args.lift(1).getOrElse("../corpora/multi/mining/articles")
